...
echo -e "\n\n"
echo "Welcome to the EdgeLord Pro installation."
...
echo "By proceeding with this installation, you confirm your agreement to the terms and conditions contained within the LICENSE file (https://github.com/dosyago/EdgeLordPro/blob/boss/LICENSE.md), as well as the terms at https://dosyago.com/terms.txt and https://dosyago.com/privacy.txt."
echo -e "\n"
echo "If you foresee using EdgeLordPro for commercial purposes without complying with AGPL, you must purchase a license."
...
echo -e "\n"
read -p "By proceeding with the installation, you confirm your acceptance of these terms and conditions and that you have purchased a license if your use of EdgeLordPro is intended for commercial applications that do not comply with AGPL-3.0. Do you agree to these terms? (yes/no): " answer
